...
def pilih_super():
    ...
    print "\n\033[1;94m        ❈     \x1b[1;91mTo op Process Press  CTRL+Z  \033[1;94m    ❈"
    print "   \033[1;31;48m═=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-◄═🗏"

    jalan('          \033[1;91mPUBG Start Cracking Plaese Wait ...')
    print  "  \033[1;36;48m ●═_-_=-_=_-=_==_=_=_=-=--=-=-_`~══◄►+++++++++=======+++=========═🗏"
